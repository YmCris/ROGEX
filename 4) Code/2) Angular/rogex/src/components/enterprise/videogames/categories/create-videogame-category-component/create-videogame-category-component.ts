...
@Component({
  selector: 'app-create-videogame-category-component',
  imports: [FormsModule, ReactiveFormsModule,
    SuccessfulActionComponent, UnsuccessfulActionComponent],
  templateUrl: './create-videogame-category-component.html',
  styleUrl: './create-videogame-category-component.css',
})
export class CreateVideogameCategoryComponent extends GenericUpdate<Videogame> {
  ...
  public override getPrimaryKeys(values: FormGroup): string[] {
    ...
    if (this.title == null || this.enterprise == null) {
      throw new Error("CAN'T GET THE PKS TO ADD AN CATEGORY");
    }
